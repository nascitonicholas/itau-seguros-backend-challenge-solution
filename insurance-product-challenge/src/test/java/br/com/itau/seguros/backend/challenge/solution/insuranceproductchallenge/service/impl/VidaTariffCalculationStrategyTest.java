...
class VidaTariffCalculationStrategyTest {

    @InjectMocks
    private VidaTariffCalculationStrategy strategy;

    @Test
    public void testCreateInsuranceProduct() throws Exception {
        assertEquals(BigDecimal.valueOf(103.72), strategy.calculate(BigDecimal.valueOf(100.5)).setScale(2, RoundingMode.HALF_UP));
    }
